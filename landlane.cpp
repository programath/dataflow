...
data_tw *fc_1x1_l_weight[2], *fc_1x1_m_weight[2], *fc_1x1_r_weight[2];
...
void weight_malloc_init(){
    ...
    fc_1x1_l_weight[0] = (data_tw*)malloc(128 * 2 * sizeof(data_tw));
    fc_1x1_l_weight[1] = &(fc_1x1_l_weight[0][128]);
    CHECK_MALLOC(fc_1x1_l_weight[0]);


    fc_1x1_m_weight[0] = (data_tw*)malloc(128 * 2 * sizeof(data_tw));
    fc_1x1_m_weight[1] = &(fc_1x1_m_weight[0][128]);
    CHECK_MALLOC(fc_1x1_m_weight[0]);

    fc_1x1_r_weight[0] = (data_tw*)malloc(128 * 2 * sizeof(data_tw));
    fc_1x1_r_weight[1] = &(fc_1x1_r_weight[0][128]);
    CHECK_MALLOC(fc_1x1_r_weight[0]);
...
//	load_weight(fc_1x1_r_bias, "weight/fc_1x1_right_bias.txt", 2);
    ...
    load_weight(fc_1x1_l_weight[0], "weight/fc_1x1_left_weight.txt", 2 * 128);

    load_weight(fc_1x1_m_weight[0], "weight/fc_1x1_guide_weight.txt", 2 * 128);

    load_weight(fc_1x1_r_weight[0], "weight/fc_1x1_right_weight.txt", 2 * 128);
...
void forward(){
    ...
    cout << "fc" << endl;
    fc_soft_layer((quad_tf*)conv11_2[0], (quad_tf*)conv11_2[1],
                  (quad_tw*)fc_1x1_l_weight[0], (quad_tw*)fc_1x1_l_weight[1],
                  (quad_tw*)fc_1x1_m_weight[0], (quad_tw*)fc_1x1_m_weight[1],
                  (quad_tw*)fc_1x1_r_weight[0], (quad_tw*)fc_1x1_r_weight[1],
                  (data_ro *)output_image,
                  fc_1x1_bias[0],fc_1x1_bias[1],fc_1x1_bias[2],fc_1x1_bias[3],fc_1x1_bias[4],fc_1x1_bias[5]);
