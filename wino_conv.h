...
#pragma SDS data copy(input_1[0 : fc_h*fc_w*16], input_2[0 : fc_h*fc_w*16], kernel_l[0:fc_in_ch*fc_out_ch/4], kernel_m[0:fc_in_ch*fc_out_ch/4], kernel_r[0 : fc_in_ch*fc_out_ch/4], output[0:fc_h*fc_w])
#pragma SDS data sys_port(input_1:AFI, input_2:AFI, kernel_l:AFI, kernel_m:AFI, kernel_r:AFI, output:AFI)
#pragma SDS data mem_attribute(input_1:NON_CACHEABLE, input_2:NON_CACHEABLE, kernel_l:NON_CACHEABLE, kernel_m:NON_CACHEABLE, kernel_r:NON_CACHEABLE, output:NON_CACHEABLE)
#pragma SDS data access_pattern(input_1:SEQUENTIAL, input_2:SEQUENTIAL, kernel_l:SEQUENTIAL, kernel_m:SEQUENTIAL, kernel_r:SEQUENTIAL, output:SEQUENTIAL)
#pragma SDS data data_mover(input_1:AXIDMA_SIMPLE, input_2:AXIDMA_SIMPLE, kernel_l:AXIDMA_SIMPLE, kernel_m:AXIDMA_SIMPLE, kernel_r:AXIDMA_SIMPLE, output:AXIDMA_SIMPLE)
void fc_soft_layer(quad_tf input_1[fc_h*fc_w*16], quad_tf input_2[fc_h*fc_w*16], quad_tw kernel_l[fc_in_ch*fc_out_ch/4], quad_tw kernel_m[fc_in_ch*fc_out_ch/4], quad_tw kernel_r[fc_in_ch*fc_out_ch/4], data_ro output[fc_h*fc_w], data_tw fc_bias0,data_tw fc_bias1,data_tw fc_bias2,data_tw fc_bias3,data_tw fc_bias4,data_tw fc_bias5);
